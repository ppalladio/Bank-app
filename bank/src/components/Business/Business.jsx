...
const FeatureCard = ({ icon, title, content, index }) => (
    ...
    >
        ...
        <div className="flex-1 flex flex-col ml-3">
            <h4 className="font-poppins font-semibold text-[18px] leading-[23px] mb-1 text-gray-50">
                {title}
            </h4>
            <p className="font-poppins font-normal text-16px leading-[24px] mb-1 text-gray-200">
                {content}
            </p>
        </div>
    </div>
